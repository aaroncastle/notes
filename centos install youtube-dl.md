...
- **列出所有格式的视频**
  ...
  ```shell
  youtube-dl --list-formats url 或 youtube-dl -F url
  ```
...
- **字幕文件转换**
  ...
  ```shell
  ffmpeg -i subtitle.srt subtitle.ass 或 ffmpeg -i sub.vtt sub.art
  ```
